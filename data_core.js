...
const POLITICIANS = [
  ...
  ,
    pledge_results:[
        {text:"AI・半導体、量子、核融合、バイオ、航空、宇宙、造船など17戦略分野へ集中的に投資する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"経済・産業"},
        {text:"レアアース等の重要鉱物について、鉱山開発・精錬支援や国家備蓄で安定供給を確保する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"経済安全保障"},
        {text:"対日外国投資委員会（日本版CFIUS）の創設に向けた法整備を進める。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"経済安全保障"},
        {text:"原発再稼働を進め、ペロブスカイト太陽電池・地熱等を最大限活用する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"エネルギー"},
        {text:"次世代革新炉・フュージョンエネルギーの早期社会実装を目指す。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"エネルギー"},
        {text:"地域ごとに産業クラスターを戦略的に形成する「地域未来戦略」を推進する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"地方・産業"},
        {text:"農林水産業の構造転換と田畑のフル活用により食料安全保障を確立する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"食料安全保障"},
        {text:"本年中に国家安全保障戦略を含む「三文書」を改定する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"安全保障"},
        {text:"防衛装備移転三原則の運用指針の5類型を撤廃する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"安全保障"},
        {text:"国家情報会議設置法（仮称）を早期成立させ、官邸直属の国家情報局を創設する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"安全保障"},
        {text:"外国代理人登録法等の関連法制を整える。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"安全保障"},
        {text:"標準的な出産費用の自己負担無償化のための法案を次期国会に提出する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"少子化対策"},
        {text:"中低所得者向け『給付付き税額控除』の制度設計を進める。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"税制・社会保障"},
        {text:"飲食料品を2年間、消費税の対象としないことについて国民会議で実現に向けた検討を加速する。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"税制・減税"},
        {text:"副首都機能の整備を含む国家社会機能継続性向上の法案を策定し、速やかな成立を図る。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"国土・行政"},
        {text:"外国人の住宅・土地取得や所有者把握について法律・ルールを見直す。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"経済安全保障"},
        {text:"自衛隊明記、緊急事態、合区解消・地方公共団体、教育充実の4項目を中心に憲法改正を目指す。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"憲法・政治制度"},
        {text:"皇族の養子縁組を可能とし、皇統に属する男系男子を皇族とする案を第一優先として皇室典範改正を目指す。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"憲法・政治制度"},
        {text:"旧氏の通称使用の法制化を目指す。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"社会・文化"},
        {text:"衆議院議員定数を1割削減する法案を次期国会で成立させることを目指す。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"政治改革"},
        {text:"政治資金の在り方について、令和9年9月30日までに結論を得て必要な法制措置を講じる。", status:null, date:"2026.02", context:"第51回衆院選（自民党公約）", field:"政治改革"}
      ]
},
  {
  ...
  ,
    pledge_results:[
        {text:"基礎控除を103万円から178万円へ引き上げる（手取りを増やす）。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"税制・減税"},
        {text:"住民税の控除額を引き上げる。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"税制・減税"},
        {text:"基礎控除・障がい福祉の所得制限を撤廃する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"税制・社会保障"},
        {text:"消費税を一律5％にし、インボイスを廃止する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"税制・減税"},
        {text:"社会保険料還付制度を創設する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"社会保障"},
        {text:"130万円の壁突破助成金を創設する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"雇用・社会保障"},
        {text:"賃上げする中小企業の事業主負担を半減する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"経済・雇用"},
        {text:"中低所得者向けの家賃控除制度を創設する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"住居・生活"},
        {text:"空室税を導入し、不動産の投資目的売買を抑制する。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"住居・不動産"},
        {text:"再エネ賦課金を廃止して電気代を年間約2万円程度下げる。", status:null, date:"2026", context:"第51回衆院選（国民民主党公約）", field:"エネルギー"}
      ]
},
  {
  ...
  ,
    pledge_results:[
        {text:"遠隔医療など医療のデジタル化を推進し、救急医療確保・医療人材の育成確保に取り組む", status:null, date:"2023.04", context:"2023年北海道知事選", field:"医療・デジタル"},
        {text:"子ども政策を一元的に推進し、経済的負担軽減・保育人材確保・妊産婦・不妊治療支援を充実", status:null, date:"2023.04", context:"2023年北海道知事選", field:"子育て・少子化"},
        {text:"社会経済情勢の変化に機動的に対応し、道民生活の安定と地域経済の構築に取り組む", status:null, date:"2023.04", context:"2023年北海道知事選", field:"経済・地域"},
        {text:"高齢者・ケアラー支援の充実と介護現場の負担軽減に取り組む", status:null, date:"2023.04", context:"2023年北海道知事選", field:"医療・福祉"},
        {text:"新たな感染症に対応する柔軟で機動的な体制を構築", status:null, date:"2023.04", context:"2023年北海道知事選", field:"医療・防疫"},
        {text:"市町村の避難施設整備等の促進に向け、道として財政支援を行う", status:null, date:"2023.04", context:"2023年北海道知事選", field:"安全・防災"},
        {text:"北海道新幹線の効果最大化、航空路線・道路網の充実、持続可能な物流確保に取り組む", status:null, date:"2023.04", context:"2023年北海道知事選", field:"交通・インフラ"},
        {text:"地域公共交通の確保と効果的な利用促進に取り組む", status:null, date:"2023.04", context:"2023年北海道知事選", field:"交通・インフラ"},
        {text:"輸入依存穀物・自給飼料の増産とスマート農業の推進", status:null, date:"2023.04", context:"2023年北海道知事選", field:"農業・食料"},
        {text:"栽培漁業・スマート水産業を推進し、道産水産物の魅力を発信", status:null, date:"2023.04", context:"2023年北海道知事選", field:"水産業"},
        {text:"北海道が日本の食料自給率に占める割合を2030年度までに30％に向上することを目指す", status:null, date:"2023.04", context:"2023年北海道知事選", field:"農業・食料"},
        {text:"高病原性鳥インフルエンザ、赤潮被害など様々なリスクへの対応力を強化", status:null, date:"2023.04", context:"2023年北海道知事選", field:"農業・食料"}
      ]
},
  {
  ...
  ,
    pledge_results:[
        {text:"木造住宅密集地域の解消促進", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"新たな「調節池」の整備で水害に強いまちづくり", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"無電柱化の推進", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"マンション防災の強化", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"シェルター整備でミサイルの危機から都民を守る", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"避難所改革の推進", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"富士山噴火を想定した降灰対策の実施", status:null, date:"2024.06", context:"2024年東京都知事選", field:"安全・防災"},
        {text:"無痛分娩費用の助成", status:null, date:"2024.06", context:"2024年東京都知事選", field:"子育て・少子化"},
        {text:"保育の無償化を第一子まで拡大", status:null, date:"2024.06", context:"2024年東京都知事選", field:"子育て・少子化"},
        {text:"学童保育の待機児童ゼロと質の向上", status:null, date:"2024.06", context:"2024年東京都知事選", field:"子育て・少子化"},
        {text:"子育て支援世帯への家賃負担の軽減", status:null, date:"2024.06", context:"2024年東京都知事選", field:"子育て・少子化"},
        {text:"新たな大学生向け奨学金制度の創設", status:null, date:"2024.06", context:"2024年東京都知事選", field:"教育"},
        {text:"東京都版海外留学制度の創設", status:null, date:"2024.06", context:"2024年東京都知事選", field:"教育"},
        {text:"フリースクール・不登校特例校設置など多様な学び支援", status:null, date:"2024.06", context:"2024年東京都知事選", field:"教育"},
        {text:"中学校でも35人学級へ（支援員配置強化）", status:null, date:"2024.06", context:"2024年東京都知事選", field:"教育"},
        {text:"女性活躍基本条例の制定", status:null, date:"2024.06", context:"2024年東京都知事選", field:"女性・多様性"},
        {text:"年収の壁を超える対策の加速", status:null, date:"2024.06", context:"2024年東京都知事選", field:"雇用・社会保障"},
        {text:"都独自の認知症専門病院の創設", status:null, date:"2024.06", context:"2024年東京都知事選", field:"医療・福祉"},
        {text:"東京都版介護職員昇給制度の構築", status:null, date:"2024.06", context:"2024年東京都知事選", field:"医療・福祉"},
        {text:"70歳までの就業促進", status:null, date:"2024.06", context:"2024年東京都知事選", field:"雇用・高齢者"},
        {text:"アフォーダブル住宅の推進", status:null, date:"2024.06", context:"2024年東京都知事選", field:"住居・生活"},
        {text:"シルバーパスの改善", status:null, date:"2024.06", context:"2024年東京都知事選", field:"交通・高齢者"},
        {text:"多摩モノレールの更なる延伸", status:null, date:"2024.06", context:"2024年東京都知事選", field:"交通・インフラ"},
        {text:"多摩モノレールをシルバーパス対象に", status:null, date:"2024.06", context:"2024年東京都知事選", field:"交通・インフラ"},
        {text:"行政手続きの100％デジタル化", status:null, date:"2024.06", context:"2024年東京都知事選", field:"デジタル・行政改革"},
        {text:"TOKYOダッシュボード（仮称）による行政データの可視化", status:null, date:"2024.06", context:"2024年東京都知事選", field:"デジタル・行政改革"},
        {text:"TOKYOスーパーアプリの開発", status:null, date:"2024.06", context:"2024年東京都知事選", field:"デジタル・行政改革"},
        {text:"中小企業の賃上げを徹底支援", status:null, date:"2024.06", context:"2024年東京都知事選", field:"経済・雇用"},
        {text:"カスハラ条例の制定", status:null, date:"2024.06", context:"2024年東京都知事選", field:"雇用・社会"},
        {text:"世界をリードする脱炭素の取組を加速", status:null, date:"2024.06", context:"2024年東京都知事選", field:"環境・エネルギー"}
      ]
},
  {
